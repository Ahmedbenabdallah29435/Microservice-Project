...
RentalOfferRepository rentalOfferRepository;
    ...
    @Override
    public int addRentalContract(RentalContract rentalContract, int userId,int rentalOfferId) throws MessagingException {
...
List<RentalContract> rentalContractList=rentalContractRepository.getActiveRentalContractByDates(rentalContract.getStartdate(),rentalContract.getEnddate());
   ...
   /* @Override
    ...
    @Override
    public double getChiffreAffaireByUser(int userId) {
...
if (rentalOffer.getUser().getUserid()==userId){
...
List<RentalContract> rentalContractListUser=new ArrayList<>();
    ...
    */
    ...
    public void exportcontrat(int idContrat, String filePath) throws IOException {
        try {
            RentalContract rentalContract = rentalContractRepository.findById(idContrat).get();
            ...
            String htmlContent = "<!DOCTYPE html> \n" +
                    ...
                    "      <h1>Tech Master</h1> \n \n" +
                    "      \n" +
                    "      <p>Date Contract: "+ rentalContract.getStartdate() +"</p>\n" +
                    "      <p>Date Contract: "+ rentalContract.getEnddate() +"</p>\n" +

                    "      <p>Price: "+rentalContract.getPrice() +"</p>\n" +
                    "      <p>NomClient: "+ rentalContract.getUserRentalcontract().getLastname()+" </p>\n" +
